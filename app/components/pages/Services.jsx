            ...
            <div className='landing-services'>
                <div className='landing-services-block'>
                    ...
                    <div className='row landing-services-block-center'>
                        Здесь собраны наиболее популярные сервисы, игры и боты, которые могут оказаться полезными для взаимодействия с блокчейном Голос.
                    </div>                    
                    <br />
                    <div className='row'>                            
                        <a target="_blank" href="https://golostalk.com" className="golos-btn btn-secondary btn-round"><Icon name="chatboxes" /> Форум GolosTalk</a>&nbsp;<a target="_blank" href="/msgs" className="golos-btn btn-secondary btn-round"><Icon name="new/envelope" /> Мессенджер</a>&nbsp;<a target="_blank" href="/market" className="golos-btn btn-secondary btn-round"><Icon name="trade" /> Биржа GolosDEX</a>&nbsp;<a target="_blank" href="/search" className="golos-btn btn-secondary btn-round"><Icon name="new/search" /> Поиск по контенту</a>&nbsp;<a target="_blank" href="https://explorer.golos.id/" className="golos-btn btn-secondary btn-round"><Icon name="cog" /> Explorer</a>
                    </div>
                </div>
                <div className='landing-services-block'>
                    <div className='column large-12 medium-12 small-12'>
                        ...
                        <div className='column large-12 medium-12 small-12'>
                            <div className='row'>
                                ...
                                <div className=' column large-12 medium-12 small-12'>
                                    ...
                                    <p>Большое количество разнообразных инструментов для работы с блокчейном и получения из него информации... <a href="/@denis-skripnik/dpos-space-services-worker">{tt('g.more_hint')}</a> <Icon name="extlink" /></p>
                                    ...
                                    <p>Функциональный и удобный сервис для получения информации из блокчейна о любом аккаунте и истории операций... <a href="/@vik/explorer-guide">{tt('g.more_hint')}</a> <Icon name="extlink" /></p>
                                </div>
                            </div>
                        </div>
                        <div className='column large-12 medium-12 small-12'>
                    ...
                    <div className='column large-12 medium-12 small-12'>
                        ...
                        <div className='column large-12 medium-12 small-12'>
                            <div className='row'>
                                ...
                                <div className=' column large-12 medium-12 small-12'>
                                    <h4><a target="_blank" rel="noopener noreferrer" href="https://sol.pisolog.net"><Icon name="new/monitor" /> Пасьянс Косынка</a></h4>
                                    Разработчик <a href="/@bitwheeze">@bitwheeze</a>
                        ...
                        <div className='column large-12 medium-12 small-12'>
                            <div className='row'>
                                ...
                                <div className=' column large-12 medium-12 small-12'>
                                    ...
                                    <p>Сканер о событиях в блокчейне с подпиской на интересуемые аккаунты и/или операции...</p>
