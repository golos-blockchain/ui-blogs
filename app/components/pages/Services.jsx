        ...
        return (
            <div className='landing-services'>
                <div className='landing-services-block'>                    
                    ...
                    <br />
                    <div className='row'>                            
                        <a target="_blank" href="https://dex.golos.app" className="golos-btn btn-secondary btn-round"><Icon name="trade" /> Golos Exchange <span className='new'>new</span></a>&nbsp;<a target="_blank" href="https://chat.golos.app" className="golos-btn btn-secondary btn-round"><Icon name="new/envelope" /> Golos Messenger</a>&nbsp;<a target="_blank" href="https://golostalk.com" className="golos-btn btn-secondary btn-round"><Icon name="chatboxes" /> Golos Forum </a>&nbsp;<a target="_blank" href="/search" className="golos-btn btn-secondary btn-round"><Icon name="new/search" /> Golos Search</a>&nbsp;<a target="_blank" href="https://golos.app" className="golos-btn btn-secondary btn-round"><Icon name="key" /> Golos Signer</a>
                    </div>
                </div>
                <div className='landing-services-block'>
                        ...
                        <div className='row'>
                            <div className='column large-12 medium-12 small-12'>
                                <p className='landing-services-block-text landing-services-block-center'>
                                    {tt('services.footer_1')} <a target="_blank" href='https://t.me/golos_id_issue'>golos_id_issue</a> {tt('services.footer_2')}.
                                </p>
                            </div>
                        </div>
                    </div>
