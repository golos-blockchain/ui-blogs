                        ...
                        <div className='column large-12 medium-12 small-12'>
                            <div className='row'>
                                ...
                                <div className='landing-exchanges-block-center column large-12 medium-12 small-12'>
                                    ...
                                    <a href="/@on0tole/pryamaya-pokupka-tokenov-golos-za-rubli-i-ne-tolko">{tt('g.more_hint')}</a> <Icon name="extlink" />
                                </div>
                            </div>
                        </div>
                        <div className='column large-12 medium-12 small-12'>
                        ...
                        <div className='column large-12 medium-12 small-12'>
                            <div className='row'>
                                ...
                                <div className='landing-exchanges-block-center column large-12 medium-12 small-12'>
                                    ...
                                    <p><Icon name="line" /> <a href="/@ecurrex-ru/ymrub-umer-da-zdravstvuet-ymrub">YMRUB</a> <small>(эквивалент рубля, с поддержкой ADVcash и PAYEER)</small>, обсуждение сервиса <a target="_blank" href="https://golostalk.com/services/@ecurrex-ru/ecurrex-tokeny-ymxxx">на форуме</a></p>
                                    <p><Icon name="line" /> <a href="/@golos.doge/doge-dogecoin-na-golose-avtomaticheskii-shlyuz-vvod-vyvod-i-torgi-na-vnutrennei-birzhe">DOGECOIN</a> <small>(позволяющий вести обмен через популярные биржи)</small> от эмитента <a href="/@golos.doge">@golos.doge</a></p>
                                    <p><Icon name="line" /> <a href="/@ecurrex-ru/anons-shlyuza-dash">YMDASH</a>, <a href="/@ecurrex-ru/prizm-na-golose">YMPZM</a>, <a href="/@ecurrex-ru/anons-shlyuzov-dlya-hive-i-steem">YMSTEEM и YMHIVE</a> от эмитента <a href="/@ecurrex-ru">@ecurrex-ru</a></p>
                                    <p><a href="/market">Перейти на Golos DEX</a> <Icon name="extlink" /></p>
                                </div>
                            </div>
                        </div>
                        <div className='column large-12 medium-12 small-12'>
