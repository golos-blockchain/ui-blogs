           ...
           <div className="PromotePost row">
               <div className="column small-12">
                   <form onSubmit={this.onSubmit} onChange={() => this.setState({trxError: ''})}>
                       ...
                       <div>{`${tt('transfer_jsx.balance')}: ${balance} ${DEBT_TOKEN_SHORT} `} <span className="secondary">({tt('promote_post_jsx.buy_gbg')} <a href="/market/GBG/GOLOS">{tt('promote_post_jsx.market')}</a>)</span></div>
                       <br />
