            ...
            <div className="PostFull__footer row">
                ...
                <div className="RightShare__Menu small-11 medium-5 large-5 columns text-right">
                    ...
                    <span className={"shareMenu"}>
                        <div className="sharpay_widget_simple" data-sharpay="golid" data-lang="ru" data-height="20" data-form="no" data-align="right" data-limit="3" data-networks="facebook,twitter,vkontakte,odnoklassniki,mailru,livejournal"></div>
                    </span>
                </div>
            </div>
        );
