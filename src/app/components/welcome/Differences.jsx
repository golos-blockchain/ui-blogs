...
const items = [
    ...
    },
    {
        header: 'Сохранность',
        pic: 'bitcoin-chain',
        description: 'Всё что было написано на Голосе останется в блокчейне навсегда. Даже при редактировании или удалении, каждый шаг останется в неизменной цепочке блоков, хранящейся на множестве серверов.',
    },
];
