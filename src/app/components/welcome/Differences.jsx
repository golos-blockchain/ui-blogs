...
const items = [
    ...
    },
    {
        ...
        pic: 'website',
        description:
            'В отличие от других блог-платформ, у нас есть не одна, а несколько лент. Новое — всё, что недавно опубликовали, обсуждаемое — посты с активными дискуссиями, и популярное — посты с наибольшей поддержкой сообщества.',
    },
    {
        header: 'Токены',
        pic: 'bitcoin',
    ...
    },
    {
        header: 'Сохранность',
        pic: 'bitcoin-chain',
        description: 'Всё что было написано на Голосе останется в блокчейне навсегда. Даже при редактировании или удалении, всё останется в неизменной цепочке блоков, хранящейся на множестве серверов.',
    },
];
